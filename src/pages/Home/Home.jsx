...
import SOP from "../../assets/Motivation Letter.pdf"
...
export const Home = () => {
  return (
    <div className='pageContainer'>
      ...
      <div className='margin' />
      <h2>Currently, <span className='color'>I am looking for graduate positions</span> to continue my research in the fields of Software Engineering, HCI and Applied AI. For more details on my research interests and goals, you can check out my <a href={SOP}>Motivation Letter</a> or visit the <a href="/my-website/#/Research">Research section</a>.</h2>
      <h2>You can find the complete details on my research and work experience in <a href = {CV}>my CV.</a></h2>
    </div>
  );
}
